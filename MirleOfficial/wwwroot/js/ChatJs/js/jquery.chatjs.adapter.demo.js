...
var DemoAdapterConstants = (function () {
    ...
    DemoAdapterConstants.ECHOBOT_REPLY_DELAY = 0;//3000;
...
var DemoServerAdapter = (function () {
    function DemoServerAdapter(clientAdapter) {
        ...
        myUser.Name = "rogerroan";
        myUser.Email = "rogerroan@gmail.com";
        myUser.ProfilePictureUrl = "https://cdn1.iconfinder.com/data/icons/mix-color-4/502/Untitled-1-512.png";
        ...
        echoBotUser.Name = "盟立小幫手";
        echoBotUser.Email = "rogerroan@mirle.com.tw";
        echoBotUser.ProfilePictureUrl = "https://www.mirle.com.tw/Upload/home/service.png";
        ...
        setTimeout(function () {
            _this.getUserInfo(otherUserId, function (echobotUserInfo) {
                ...
                setTimeout(function () {
                    ...
                    //$.post("../../../api/menus/botQ", post).done(function (posts) {
                    $.post("https://www.mirle.com.tw/api/menus/botQ", post).done(function (posts) {

                        //var jsonobj = jQuery.parseJSON(posts);
                        var jsonobj = jQuery.parseJSON(JSON.stringify(posts));
                        ...
                        echoMessage.Message = jsonobj.response;
